...
test.describe("Item CRUD", () => {
  ...
  test("should create a new item", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: "Sword of Testing" })
    ).toBeVisible();
  });
  ...
  test("should view item details", async ({ page }) => {
    ...
    await expect(
      page.getByText("A legendary sword forged for testing purposes.")
    ).toBeVisible();
  });
  ...
  test("should edit an item", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: "Updated Sword" })
    ).toBeVisible();
  ...
  test("should delete an item", async ({ page }) => {
    ...
    await expect(
      page.getByRole("link", { name: "Updated Sword" })
    ).not.toBeVisible();
  });
  ...
  test("should create item with all fields", async ({ page }) => {
    ...
    await expect(page.getByText("Item created successfully")).toBeVisible();
    await expect(
      page.getByRole("heading", { name: "Complete Item" })
    ).toBeVisible();
  ...
  test("should filter items by type", async ({ page }) => {
    ...
    await expect(
      page.getByRole("link", { name: "Health Potion" })
    ).toBeVisible();
    await expect(
      page.getByRole("link", { name: "Magic Scroll" })
    ).toBeVisible();
  });
  ...
  test("should cancel item creation", async ({ page }) => {
    ...
    await expect(
      page.getByRole("link", { name: "Cancelled Item" })
    ).not.toBeVisible();
  });
