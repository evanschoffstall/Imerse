...
test.describe('Location Management', () => {
  ...
  test.skip('should display empty state when no locations exist', async ({ page }) => {
  ...
  test.skip('should create a child location with parent', async ({ page }) => {
    ...
    await page.getByLabel('Parent Location').selectOption({ label: 'Middle-earth' })
    ...
    await expect(page.getByRole('link', { name: 'Middle-earth' })).toBeVisible()
  })
  ...
  test.skip('should view location details with children', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'Middle-earth' })).toBeVisible()
    await expect(page.getByText('Continent')).toBeVisible()
    
    // Should show sub-locations section
    await expect(page.getByRole('heading', { name: 'Sub-Locations' })).toBeVisible()
  ...
  test.skip('should edit a location', async ({ page }) => {
    ...
    // Add map image
    await page.getByLabel('Map Image URL').fill('https://example.com/gondor-map.jpg')
  ...
  test.skip('should prevent deleting location with children', async ({ page }) => {
    const campaignId = 'test-campaign-id'
  ...
  test.skip('should delete a location without children', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'Minas Tirith' })).not.toBeVisible()
  })
  ...
  test.skip('should handle location privacy settings', async ({ page }) => {
    ...
    await page.getByText('Private (only visible to campaign owner and creator)').click()
  ...
  test.skip('should navigate through hierarchy with breadcrumbs', async ({ page }) => {
    const campaignId = 'test-campaign-id'
  ...
  test.skip('should show campaign requirement warning', async ({ page }) => {
    ...
    await expect(page.getByText('Please select a campaign to view locations')).toBeVisible()
  })

  test.skip('should filter parent options to prevent self-reference', async ({ page }) => {
    const campaignId = 'test-campaign-id'
