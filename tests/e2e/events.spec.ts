...
test.describe('Event CRUD', () => {
  ...
  test('should create a new event', async ({ page }) => {
    ...
    // Fill form
    await page.getByLabel('Name', { exact: true }).fill('Battle of Five Armies')
    ...
    await expect(page.getByRole('heading', { name: 'Battle of Five Armies' })).toBeVisible()
  })
  ...
  test('should edit an event', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'Updated Event Name' })).toBeVisible()
  ...
  test('should delete an event', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'Updated Event Name' })).not.toBeVisible()
  })
  ...
  test('should create event with all fields', async ({ page }) => {
    ...
    // Verify all fields
    await expect(page.getByText('Event created successfully')).toBeVisible()
    await expect(page.getByRole('heading', { name: 'Complete Event' })).toBeVisible()
  ...
  test('should cancel event creation', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'Cancelled Event' })).not.toBeVisible()
  })
})
