...
test.describe('Quest CRUD', () => {
  ...
  test('should create a new quest', async ({ page }) => {
    ...
    // Fill form
    await page.getByLabel('Name', { exact: true }).fill('Retrieve the Ancient Artifact')
    ...
    await editor.click()
    await editor.fill('A legendary artifact has been stolen and must be retrieved.')
    ...
    await expect(page.getByRole('heading', { name: 'Retrieve the Ancient Artifact' })).toBeVisible()
  })
  ...
  test('should view quest details', async ({ page }) => {
    ...
    await page.getByRole('link', { name: 'Retrieve the Ancient Artifact' }).click()
    
    // Verify details page
    await expect(page.getByRole('heading', { name: 'Retrieve the Ancient Artifact' })).toBeVisible()
    await expect(page.getByText('Main Quest')).toBeVisible()
    await expect(page.getByText('Active')).toBeVisible()
    await expect(page.getByText('A legendary artifact has been stolen and must be retrieved.')).toBeVisible()
  })
  ...
  test('should edit a quest', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'Updated Quest Name' })).toBeVisible()
  ...
  test('should delete a quest', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'Updated Quest Name' })).not.toBeVisible()
  })
  ...
  test('should create quest with all fields', async ({ page }) => {
    ...
    // Verify all fields
    await expect(page.getByText('Quest created successfully')).toBeVisible()
    await expect(page.getByRole('heading', { name: 'Complete Quest' })).toBeVisible()
  ...
  test('should cancel quest creation', async ({ page }) => {
    ...
    await expect(page.getByRole('link', { name: 'Cancelled Quest' })).not.toBeVisible()
  })
