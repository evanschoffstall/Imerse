...
test.describe('Campaign Management', () => {
  ...
  test.describe('Campaign List', () => {
    ...
    test.skip('should paginate campaigns when there are many', async ({ page }) => {
      await page.goto('/campaigns');
  ...
  test.describe('Campaign Creation', () => {
    ...
    test.skip('should create campaign with rich text description', async ({ page }) => {
      await page.goto('/campaigns/new');
  ...
  test.describe('Campaign Detail', () => {
    ...
    test.skip('should show campaign entities (characters, locations)', async ({ page }) => {
      await page.goto('/campaigns/1');
  ...
  test.describe('Campaign Delete', () => {
    test.skip('should show confirmation dialog before delete', async ({ page }) => {
      await page.goto('/campaigns/1');
      ...
      await expect(dialog.locator('text=/confirm|are you sure/i')).toBeVisible();
    });
    ...
    test.skip('should delete campaign successfully', async ({ page }) => {
      ...
      await expect(page.locator(`text=Campaign ${testCampaignId}`)).not.toBeVisible();
    });
  });
  ...
  test.describe('Campaign Permissions', () => {
    ...
    test.skip('should not allow member to delete campaign', async ({ page }) => {
